...
-- Create default user "sacal" with password "guacadmin"
INSERT INTO guacamole_entity (name, type) VALUES ('sacal', 'USER');
...
SELECT
    ...
    CURRENT_TIMESTAMP
FROM guacamole_entity WHERE name = 'sacal' AND guacamole_entity.type = 'USER';
...
FROM (
    VALUES
        ('sacal', 'CREATE_CONNECTION'),
        ('sacal', 'CREATE_CONNECTION_GROUP'),
        ('sacal', 'CREATE_SHARING_PROFILE'),
        ('sacal', 'CREATE_USER'),
        ('sacal', 'CREATE_USER_GROUP'),
        ('sacal', 'ADMINISTER')
